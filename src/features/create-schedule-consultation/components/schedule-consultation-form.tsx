                ...
                <div className="mb-8 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Busque um paciente existente ou cadastre um novo e defina o horário da consulta
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Pesquise por nome ou CPF. Se não encontrar, preencha os dados abaixo.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                {isNewPatient && (
                                    <>
                                        ...
                                        <NewPatientFields formData={formData} setFormData={setFormData} />
                                    </>
                                )}
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Data e hora são salvas em UTC. Horário exibido conforme fuso do sistema.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
